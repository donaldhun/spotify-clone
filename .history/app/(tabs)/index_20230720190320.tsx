...
function AlbumThumbnail(props: { name: string }) {
  ...
  return <Image source={imageSource} style={{ width: 75, height: 75, borderRadius:5 }}/>;
}
...
export default function TabOneScreen() {
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style = {{backgroundColor: 'rgb(54, 135, 54)', width: "100%", marginTop: 25, flexDirection:'row'}}>
        <View style={{backgroundColor: 'rgb(31, 31, 31)', borderRadius: 5, flexDirection: 'row', width: 190, alignItems: 'center'}}>
          <AlbumThumbnail name="the_stage"/>
          <Text style={{fontWeight:'bold'}}>A7x</Text>
        </View>
