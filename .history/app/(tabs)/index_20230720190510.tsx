...
export default function TabOneScreen() {
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style = {{backgroundColor: 'rgb(54, 135, 54)', width: "100%", marginTop: 25, flexDirection:'row',justifyContent: 'space-between'}}>
        ...
        <View style={{backgroundColor: 'rgb(31, 31, 31)', borderRadius: 5, flexDirection: 'row', width: 170, alignItems: 'center'}}>
          <AlbumThumbnail name="the_stage"/>
          <Text style={{fontWeight:'bold', marginLeft: 8}}>A7x</Text>
        </View>
